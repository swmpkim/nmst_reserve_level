...
-  should EIR be included in the multivariate analyses, as a column in the response matrix?
...
-  show which species are within each category used in the anaSpec_df data frames - or each application (spatial plots, univariate responses, multivariate responses)  
