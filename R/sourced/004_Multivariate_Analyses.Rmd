...
-   Black arrows and text represent Species or Categories of vegetation (e.g. H-Halophyte) identified by the reserve in the 'Analysis_Specs' sheet of the 'veg-specs.xlsx' file. Hovering over the arrow will provide the Species or Category name.\
...
if(is.na(addlOptions$Choice[addlOptions$R_param == "addlNMDSoption"])){
    cat("No additional loadings specified. If you would like to graph additional environmental factors on the NMDS plot, please specify them in the 'NMDS additional loadings' section of 'More_Options' sheet in the veg-specs.xlsx file.")
} else {
