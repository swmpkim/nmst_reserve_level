...
If the above permutational test for differences in community response between zones was significant, zone-wise tests are below. Otherwise, all zones were combined for one test of start vs. end community change.
...
The below plots, rather than using arrows for individual species or vegetation groups, create contours for the specific values of each.    

<details><summary>Click to expand if you would like to see contour plots.</summary>
