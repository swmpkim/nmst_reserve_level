...
```{r stats-find-r2, warning = FALSE, message = FALSE}
...
```{r stats-graph-quiltplot, fig.width = 8, fig.height = 7}
fields::quilt.plot(x = stn_tbl$Long, y = stn_tbl$Lat, z = unlist(ranef(mod_plts)$StTrnsPlt),
                   nx = 128, ny = 128)
```
...
```{r stats-graph-predictions, warning = FALSE, message = FALSE}
if(exists("mod_plts")){
