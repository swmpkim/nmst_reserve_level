...
# MODIFIED DF SELECTION HERE  

Probably also need to make sure the same plots exist in both the starting and ending years  
`StTrnsPlt`  
...
# THIS IS WHERE I'M CHANGING THE PERMANOVA  
