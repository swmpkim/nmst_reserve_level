...
For the model with transect/plot nesting. Some notes from the function. Kenward-Roger method used to estimate denominator degrees of freedom. Confidence level used: 0.95. p-value adjustment: Tukey. alpha = 0.05.  
...
if(exists("mod_nested2_lme4")){
    ...
    ggplot(mod_cld, aes(x = reorder(Vegetation_Zone, Years_sinceStart.trend),
